...
Ext.onReady(function() {
    ...
    var formPanel2 = Ext.create('Ext.form.Panel', {
        ...
        buttons: [{
			...
			{                
				...
				/**** Form fields ****/
                var title = $('#txtTitle-inputEl').val();
				...
				//Ext.Msg.alert('Message', 'name= '+firstname);
                $("#lbl").show();
				...
				,function(result)
				{
					Ext.Msg.alert('Status', ''+result, function(err){
    ...
    $("#form-1042_header").css("height","27px");
    $("#form-1042_header-innerCt").css("height","15px");
    $("#form-1042-body").css("top","28px");
	$("#form-1042-body").css("height","257px");
	$("#fieldset-1043-body").css("height","220px");
	$("#fieldset-1043").css("height","250px");
    //$("#fieldset-1057").css("height","234px");
    $("#toolbar-1044-innerCt").css("height","30px");
    $("#toolbar-1044-innerCt").css("height","30px");
    $("#toolbar-1044").css("top","290px");
    $("#toolbar-1044").css("height","45px");
    $("#toolbar-1044").css("height","32px");
	$("#button-1045").css("height","23px");
    $("#button-1045-btnEl").css("height","17px");
    $("#button-1046-btnEl").css("height","17px");
...
{
	if(document.getElementById("description-inputEl").value == "")
	{
		Ext.Msg.alert("Message","Please description");
		return false;
	}
	...
	{
	   Ext.Msg.alert("Message","Invalid description");
		return false;
