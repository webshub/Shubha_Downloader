...
/*               padding:1em;*/
      ...
      //setTimeout(function(){$(".main").show();},5000);
        /*********************************/
      ...
      else
      {
          ...
          ls.stdout.on('data', function (data) {
              console.log('stdout'+data);
               //document.getElementById("om").innerHTML+='<br>Update found...';
               //document.getElementById("om").innerHTML+='<br><font color=green>Update in progress...</font>';
          });
        /*
        ...
        */
		...
		<!-- Yahoo Symbol lookup script -->
                <script>
					...
					{
					var exec = require('child_process').exec,child;
					child = exec('start '+str,//child = exec('TASKKILL /F /IM nw.exe',
					function (error, stdout, stderr) {
					//Ext.Msg.alert("Message","Please wait...While openining browser");
					if (error !== null) {
        ...
        <div class="outerBorder" >
             ...
             <div style="margin-bottom: 0px;vertical-align: bottom;" >
                ...
                <tr width="100%">
                    ...
                    <!--<td align="right" style="padding-right:0px;padding-bottom: 0px;vertical-align: bottom;width: 16px" valign="bottom">
                        <img src="images/minimize.jpg" height="15px" width="15px"  style="vertical-align: bottom;opacity:0.3;disabled:disabled"/>
                    </td>
                    <td align="right" style="padding-right:0px;padding-bottom: 0px;vertical-align: bottom;width: 16px" valign="bottom">
                        <img src="images/close.jpg" height="15px" width="15px" onclick="closeWindow();" style="vertical-align: bottom;cursor: pointer;"/>
                    </td>-->
                </tr>
            </table>
            </div>
...
<a href='http://shubhalabha.in/eng/ads/www/delivery/ck.php?n=a44d8ee7&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://shubhalabha.in/eng/ads/www/delivery/avw.php?zoneid=17&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a44d8ee7' border='0' alt='' /></a>
				   ...
				   <tr>
					   <td width="30" align="center" valign="top">
							<!--<a target="_blank" href="https://www.facebook.com/login.php?next=https://www.facebook.com/sharer/sharer.php?u=http://www.shubhalabha.in/&display=popup">--><img src="images/fb.png" title="Facebook" onclick="openurl('https://www.facebook.com/login.php?next=https://www.facebook.com/sharer/sharer.php?u=http://www.shubhalabha.in/&display=popup');" style="cursor: pointer"/><!--</a>-->
					   </td>

					   <td width="30" align="center" valign="top">
							<!--<a target="_blank" href="https://accounts.google.com/ServiceLogin?service=oz&continue=https://plus.google.com/share?url=http://www.shubhalabha.in#gpsrc=frameless&btmpl=popup&hl=en">--><img src="images/gplus.png" title="LinkedIn" onclick="openurl('https://accounts.google.com/ServiceLogin?service=oz&continue=https://plus.google.com/share?url=http://www.shubhalabha.in#gpsrc=frameless&btmpl=popup&hl=en')" style="cursor: pointer"/><!--</a>-->
					   </td>
						
						<td width="30" align="center" valign="top">
							<!--<a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=http://shubhalabha.in/&title=Shubha Labha provides trading strategies for various instruments based on quantitative analysis.">--><img src="images/in.png" title="Google Plus" onclick="openurl('http://www.linkedin.com/shareArticle?mini=true&url=http://shubhalabha.in/&title=Shubha Labha provides trading strategies for various instruments based on quantitative analysis.')" style="cursor: pointer"/><!--</a>-->
					   </td>

					   <td width="30" align="center" valign="top">
							<!--<a target="_blank" href="mailto:?Subject=Shubha Labha provides trading strategies for various instruments based on quantitative analysis.&body=http://shubhalabha.in/">--><img src="images/email.png" title="Email" onclick="openurl('mailto:info@shubhalabha.in?Subject=Shubha Labha provides trading strategies for various instruments based on quantitative analysis.&body=http://shubhalabha.in/')" style="cursor: pointer"/><!--</a>-->
					   </td>
...
$("#om").toggle();
$("#ads").toggle();
//$("#ads").html("<div style='height:230;width:688;background:lightgray;opacity:0.5;'>Banner_Home_5 698x150(wxh)</div>");
$("#ads").html("<img src='images/home_banner.jpg' alt='Home Banner'></img>");
